  ...
  <div class="space-y-8 pb-24 pt-8">
    <div class="max-w-7xl mx-auto space-y-4">
      <div class="mb-8 space-y-4">
        <h1 class="text-4xl font-bold">堆积区域图</h1>
    ...
    <div class="grid grid-cols-2 gap-4 max-w-7xl mx-auto py-4">
      ...
      <Card>
        <template #header>
          <h2 class="text-xl my-2 font-bold">单线区域图</h2>
        </template>
      ...
      <Card>
        <template #header>
          <h2 class="text-xl my-2 font-bold">堆积面积图</h2>
        </template>
      ...
      <Card>
        <template #header>
          <h2 class="text-xl my-2 font-bold">自然区域图</h2>
        </template>
      ...
      <Card>
        <template #header>
          <h2 class="text-xl my-2 font-bold">区域图阶梯型</h2>
        </template>
        <AreaChart :data="AreaChartData4" :height="200" x-label="Month" y-label="Score" :categories="categories5"
          :y-num-ticks="4" :x-num-ticks="7" :x-formatter="(i: number) => AreaChartData4[i].month"
      ...
      <Card>
        <template #header>
          <h2 class="text-xl my-2 font-bold">区域图默认设置</h2>
        </template>
        <AreaChart :data="AreaChartData4" :height="200" x-label="Month" y-label="Score" :categories="categories5"
          :y-num-ticks="4" :x-num-ticks="7" :x-formatter="(i: number) => AreaChartData4[i].month" />
      </Card>
