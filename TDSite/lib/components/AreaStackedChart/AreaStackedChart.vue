...
<template>
  <div class="flex relative flex-col space-y-4">
    <VisXYContainer :data="data" :height="height">
      <VisArea :x="x" :y="y" :color="Object.values(props.categories).map((i) => i.color)"
    ...
    <div class="absolute items center justify-end top-0 right-0">
